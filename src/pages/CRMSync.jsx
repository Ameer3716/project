...
const CRMSync = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-[#00FFFF] mb-2">CRM Synchronization</h1>
          <p className="text-[#E42289]">Manage your CRM integrations and contact synchronization</p>
        </div>
        <motion.button

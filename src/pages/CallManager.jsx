      ...
      {activeTab === 'logs' && (
        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="relative bg-rgba(255, 255, 255, 0.05) backdrop-blur-[12px] border border-rgba(255, 255, 255, 0.2) rounded-2xl p-6 shadow-xl bg-gradient-to-r from-[#E42289] to-[#00FFFF]">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 relative">
                  <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#00FFFF]/40 w-5 h-5 "  />
                  <input
                    type="text"

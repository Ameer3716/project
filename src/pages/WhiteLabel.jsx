...
const WhiteLabel = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-[#0C0A1D] mb-2">White-Label Branding</h1>
          <p className="text-gray-600">Customize the platform with your client's branding</p>
        </div>
        <motion.button
